...
namespace FF.Cockpit.Theme.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new FF.Cockpit.Theme.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private static object TryGetResource(FF.Cockpit.Theme.Theme theme, string key)
        {
            if (theme == null)
            {
        ...
        private static FF.Cockpit.Theme.Theme DetectTheme(BaseMetroDialog dialog)
        {
            if (dialog == null)
            {
                return null;
