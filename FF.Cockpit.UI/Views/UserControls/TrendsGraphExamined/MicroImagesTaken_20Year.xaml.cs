...
{
    /// <summary>
    /// Interaction logic for PatientTrends_20Year.xaml
    /// </summary>
    public partial class MicroImagesTaken_20Year : UserControl
    {
        public MicroImagesTaken_20Year()
        {
            InitializeComponent();
            ...
            //  .Fill((value, index) => (value.PatientCount == 0 ? Brushes.Red : Brushes.White));
